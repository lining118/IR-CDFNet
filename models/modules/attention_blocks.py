...
class HOR(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.high = nn.Conv2d(in_channels, out_channels, kernel_size=1)
        self.low = nn.Conv2d(in_channels, out_channels, kernel_size=1)

        self.value = nn.Conv2d(in_channels, out_channels, kernel_size=1)
        self.softmax = nn.Softmax(dim=1)

        self.e_conv = nn.Conv2d(in_channels, out_channels, kernel_size=1)
        self.mid = nn.Conv2d(in_channels, out_channels, kernel_size=1)
        self.latter = nn.Conv2d(in_channels, out_channels, kernel_size=1)
